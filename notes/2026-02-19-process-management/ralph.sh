#!/usr/bin/env bash
# Ralph loop for unified process management implementation.
#
# Usage:
#   ./notes/2026-02-19-process-management/ralph.sh          # run until done (max 20 iterations)
#   ./notes/2026-02-19-process-management/ralph.sh 5         # run up to 5 iterations
#
