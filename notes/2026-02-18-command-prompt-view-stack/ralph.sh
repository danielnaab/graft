#!/usr/bin/env bash
# Ralph loop for TUI view stack and command line implementation.
#
# Usage:
#   ./notes/2026-02-18-command-prompt-view-stack/ralph.sh          # run until done (max 20 iterations)
#   ./notes/2026-02-18-command-prompt-view-stack/ralph.sh 5         # run up to 5 iterations
#
