#!/usr/bin/env bash
# Ralph loop for graft workspace unification.
#
# Usage:
#   ./notes/2026-02-16-workspace-unification/ralph.sh          # run until done (max 20 iterations)
#   ./notes/2026-02-16-workspace-unification/ralph.sh 5         # run up to 5 iterations
#
