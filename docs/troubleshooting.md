<!-- Generated by Graft | model=bedrock-claude-v4.5-sonnet-us | sig=72b4218e966f9db725c0d7223924faae91f57722e858e80a033c3802ad2abb89 | rev=4b99e8d | 2025-11-04 -->
...
🚀 Running DVC pipeline with 8 concurrent jobs...
...
DVC automatically parallelizes independent stages. By default, Graft runs up to 8 stages concurrently. You can adjust this:

```bash
# Run with more parallelism (if you have many independent documents)
DVC_JOBS=16 bin/graft rebuild

# Run sequentially (useful for debugging)
DVC_JOBS=1 bin/graft rebuild
```

Check if your pipeline structure allows parallelization:
