<!-- Generated by Graft | model=bedrock-claude-v4.5-sonnet-us | sig=5cd4ec554302744badb6007c235e721c696abcae7a11c71eef318559946f43c5 | rev=1c8d15b | 2025-11-08 -->
# Command Reference
...
4. Executes `dvc repro` with automatic parallelization
...
**Parallel execution:** DVC automatically parallelizes independent stages based on the dependency graph. No manual configuration needed.
...
Show DVC pipeline status—which stages have changed dependencies and need to run. This is a wrapper around `dvc status` that shows you what `rebuild` would execute.
...
- Attachment metadata (for PDFs and images)
