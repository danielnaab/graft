<!-- Generated by Graft | model=bedrock-claude-v4.5-sonnet-us | sig=123cfb15a1f6401872893014ff3e5938525ce549a7f2fbd6b324e74a905df7f9 | rev=0cfd998 | 2025-11-04 -->
# Getting Started
...
- **[Use Cases](use-cases.md)** — See practical examples of what you can build with Graft (read this next for inspiration)
- **[How It Works](how-it-works.md)** — Understand the change detection system and pipeline mechanics
- **[Configuration](configuration.md)** — Learn about model selection, custom parameters, and advanced options
- **[Command Reference](command-reference.md)** — Complete guide to all `bin/graft` commands
